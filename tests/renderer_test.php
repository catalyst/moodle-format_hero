...
/**
 * Unit tesst for format_hero renderer class.
 *
 * @package    format_hero
 ...
 * @group      format_hero
 */
class format_hero_renderer_testcase extends advanced_testcase {
    ...
    public function test_get_completion_counts() {
        ...
        $content = new \format_hero\output\courseformat\content($format);
        $method = new ReflectionMethod('format_hero\output\courseformat\content', 'get_completion_counts');
