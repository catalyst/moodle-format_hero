...
namespace format_hero\output\courseformat;
...
class content extends content_base {
    ...
    public function get_template_name(renderer_base $renderer): string {
        return 'format_hero/local/content';
    }
    ...
    public function print_single_section_page(renderer_base $output): stdClass {
        ...
        $templatecontext->sectioncmcontrol = $output->course_section_add_cm_control($course, $displaysection, $displaysection);
     ...
     */
    protected function section_nav_selection($course, $sections, $displaysection, $output): string {
        $o = '';
        $sectionmenu = array();
